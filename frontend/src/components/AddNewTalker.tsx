...
export default function AddNewTalker({ openWindow }:AddNewTalkerProps) {
  ...
  return (
    ...
    >
      <form
        className='bg-gray-200 rounded p-5 z-10 relative flex justify-center items-center'
        ...
        />
        <button
          className='text-sm cursor-pointer absolute top-0 right-1'
        ...
        <button
          className='bg-green-800 disabled:opacity-80 disabled:cursor-not-allowed focus:hover:bg-green-700 rounded p-2 text-white w-20  flex justify-center items-center'
          type="submit"
